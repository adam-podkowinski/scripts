...
DXVK_HUD=fps WINEFSYNC=1 STEAM_COMPAT_CLIENT_INSTALL_PATH="$HOME/.steam/steam" STEAM_COMPAT_DATA_PATH=$HOME/.local/share/proton-pfx/$2 gamemoderun ~/.steam/root/compatibilitytools.d/$1/proton run $3
